...
player_hud::player_hud()
{
	...
	m_bone_callback_params.insert(std::make_pair(r_finger0, xr_new<BoneCallbackParams>()));
	m_bone_callback_params.insert(std::make_pair(r_finger01, xr_new<BoneCallbackParams>()));
	m_bone_callback_params.insert(std::make_pair(r_finger02, xr_new<BoneCallbackParams>()));
