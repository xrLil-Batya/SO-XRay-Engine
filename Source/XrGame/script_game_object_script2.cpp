...
//		.def("get_bleeding",				&CScriptGameObject::GetBleeding)
		...
		.def("weight", &CScriptGameObject::GetWeight)
		.def("set_weight", &CScriptGameObject::SetWeight)
//-------------- Artefacts Restore Type Getters
		.def("get_artefact_hit_on_take", &CScriptGameObject::GetArtefactHitOnTake)
		.def("get_artefact_rank", &CScriptGameObject::GetArtefactRank)
		.def("get_artefact_radiation_restore_speed", &CScriptGameObject::GetRadiationSpeed)
		.def("get_artefact_health_restore_speed", &CScriptGameObject::GetHealthSpeed)
		.def("get_artefact_satiety_restore_speed", &CScriptGameObject::GetSatietySpeed)
		.def("get_artefact_power_restore_speed", &CScriptGameObject::GetPowerSpeed)
		.def("get_artefact_bleeding_restore_speed", &CScriptGameObject::GetBleedingSpeed)
		.def("get_artefact_psyhealth_restore_speed", &CScriptGameObject::GetPsyhealthSpeed)
		.def("get_artefact_additional_weight", &CScriptGameObject::GetAdditionalWeight)
		.def("get_artefact_walk_accel", &CScriptGameObject::GetArtefactWalkAccel)
		.def("get_artefact_jump_speed", &CScriptGameObject::GetArtefactJumpSpeed)
//-------------- Artefacts Immunities Getters
		.def("get_artefact_burn_immunity", &CScriptGameObject::GetBurnImmunity)
		.def("get_artefact_strike_immunity", &CScriptGameObject::GetStrikeImmunity)
		.def("get_artefact_shock_immunity", &CScriptGameObject::GetShockImmunity)
		.def("get_artefact_wound_immunity", &CScriptGameObject::GetWoundImmunity)
		.def("get_artefact_radiation_immunity", &CScriptGameObject::GetRadiationImmunity)
		.def("get_artefact_telepatic_immunity", &CScriptGameObject::GetTelepaticImmunity)
		.def("get_artefact_chemical_burn_immunity", &CScriptGameObject::GetChemicalBurnImmunity)
		.def("get_artefact_explosion_immunity", &CScriptGameObject::GetExplosionImmunity)
		.def("get_artefact_fire_wound_immunity", &CScriptGameObject::GetFireWoundImmunity)
//-------------- Artefacts Restore Type Setters
		.def("set_artefact_hit_on_take", &CScriptGameObject::SetArtefactHitOnTake)
		.def("set_artefact_rank", &CScriptGameObject::SetArtefactRank)
		.def("set_artefact_radiation_restore_speed", &CScriptGameObject::SetRadiationSpeed)
		.def("set_artefact_health_restore_speed", &CScriptGameObject::SetHealthSpeed)
		.def("set_artefact_satiety_restore_speed", &CScriptGameObject::SetSatietySpeed)
		.def("set_artefact_power_restore_speed", &CScriptGameObject::SetPowerSpeed)
		.def("set_artefact_bleeding_restore_speed", &CScriptGameObject::SetBleedingSpeed)
		.def("set_artefact_psyhealth_restore_speed", &CScriptGameObject::SetPsyhealthSpeed)
		.def("set_artefact_additional_weight", &CScriptGameObject::SetAdditionalWeight)
		.def("set_artefact_walk_accel", &CScriptGameObject::SetArtefactWalkAccel)
		.def("set_artefact_jump_speed", &CScriptGameObject::SetArtefactJumpSpeed)
//-------------- Artefacts Immunities Setters
		.def("set_artefact_burn_immunity", &CScriptGameObject::SetBurnImmunity)
		.def("set_artefact_strike_immunity", &CScriptGameObject::SetStrikeImmunity)
		.def("set_artefact_shock_immunity", &CScriptGameObject::SetShockImmunity)
		.def("set_artefact_wound_immunity", &CScriptGameObject::SetWoundImmunity)
		.def("set_artefact_radiation_immunity", &CScriptGameObject::SetRadiationImmunity)
		.def("set_artefact_telepatic_immunity", &CScriptGameObject::SetTelepaticImmunity)
		.def("set_artefact_chemical_burn_immunity", &CScriptGameObject::SetChemicalBurnImmunity)
		.def("set_artefact_explosion_immunity", &CScriptGameObject::SetExplosionImmunity)
		.def("set_artefact_fire_wound_immunity", &CScriptGameObject::SetFireWoundImmunity)
//-------------- Artefacts  End
